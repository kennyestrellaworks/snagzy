...
export const AnalyticsLayout = () => {
  ...
  return (
    <div
      className="flex flex-col w-full border rounded-md overflow-hidden"
      style={{ background: "var(--bg-badge)", borderColor: "var(--border)" }}
    >
      <div className="flex flex-col w-full z-50">
        <div className="flex w-full justify-between items-center pl-2 pr-2 pt-2 z-20">
          <div className="flex gap-2 justify-between">
            <h1 style={{ color: "var(--text-sidebar)" }}>Analytics</h1>
          </div>
              ...
              {analyticsLayoutNavLinks.length === 0 ? (
                ...
                analyticsLayoutNavLinks.map((analyticsLayoutNavLink, index) => (
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `analytics-tabs flex items-center gap-2 py-1 px-3 text-[14px] rounded-t-md transition-all ${
                        isActive ? "analytics-tabs-active" : ""
                      }`
                    }
                    // className={({ isActive }) =>
                    //   `analytics-tabs flex items-center gap-2 py-1 px-3 text-[14px] rounded-t-md transition-all ${
        ...
        <div
          className="flex pl-2 pr-2 w-full justify-between items-center border-t border-b z-10 py-1"
          style={{
            borderColor: "var(--bg-sidebar-active)",
