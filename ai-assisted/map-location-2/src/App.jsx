    ...
    try {
      const { data, error } = await supabase
        ...
        .insert([{
          ...
          city: pinData.city,
          suburb: pinData.suburb,
          district: pinData.district,
          neighborhood: pinData.neighborhood,
          address_line1: pinData.address_line1,
          address_line2: pinData.address_line2,
              ...
              <div className="p-4 border-t border-gray-200 bg-white">
                <div className="text-sm text-gray-600">
                  ...
                  <p className="text-gray-800">
                    {selectedPin.city || selectedPin.suburb || selectedPin.district || selectedPin.country || 'Unnamed Location'}
                  </p>
